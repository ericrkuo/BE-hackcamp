...
const dish1 = new Dish(user1, [recipe1, recipe2], [nutrition1, nutrition2], "Giant Sushi", CuisineType.JAPANESE, ["rice", "salmon", "cucumber", "seaweed"], "test", "test", "https://user-images.githubusercontent.com/49849754/101288415-4a467980-37ab-11eb-8a3a-ae40e73d2e6d.png");
const dish2 = new Dish(user1, [recipe3, recipe4], [nutrition3, nutrition4], "Delicious Korean BBQ", CuisineType.KOREAN, ["meat", "korean bbq sauce"], "", "", "https://user-images.githubusercontent.com/49849754/101288450-7feb6280-37ab-11eb-9292-28fe8478c355.png");
const dish3 = new Dish(user2, [recipe5, recipe6], [nutrition5, nutrition6], "Schnitzel", CuisineType.GERMAN, ["mushroom", "peppers", "pork"], "", "", "https://user-images.githubusercontent.com/49849754/101288717-e45af180-37ac-11eb-9429-5362091bef0c.png");
const dish4 = new Dish(user2, [recipe7, recipe8], [nutrition7, nutrition8], "Amygdalota", CuisineType.GREEK, ["almonds", "flour", "sugar", "egg whites", "almond extract"], "", "", "https://user-images.githubusercontent.com/49849754/101288852-a3171180-37ad-11eb-9634-44e86760e424.png");
